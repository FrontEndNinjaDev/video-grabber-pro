    ...
    <div className="container mx-auto max-w-6xl px-4">
      ...
      <div className="text-center mb-16">
        <div className="mb-6">
          <div className="relative mx-auto w-20 h-20 mb-6">
            ...
            <div className="relative flex items-center justify-center w-full h-full">
              <Waves className="text-white animate-pulse" size={40} />
            </div>
          </div>
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 bg-gradient-to-r from-cyan-400 via-blue-400 to-teal-400 bg-clip-text text-transparent">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-sm">
          <span className="bg-cyan-500/20 px-4 py-2 rounded-full text-cyan-300 flex items-center space-x-2">
            <Globe size={16} />
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            What Video Grabber Pro Can Do
          </h2>
          <p className="text-lg text-blue-200 max-w-3xl mx-auto">
            Video Grabber Pro is a comprehensive, free online video downloader
            that supports thousands of platforms with professional-grade
            features and guaranteed quality.
          </p>
        </div>
      ...
      <div className="mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {supportedPlatforms.slice(0, 4).map((platform, index) => (
            <GlassCard
              key={index}
              className="p-6 text-center border-l-4 border-l-cyan-400 hover:scale-105 transition-transform duration-300"
            >
              <platform.icon
                className={`mx-auto mb-4 ${platform.color}`}
                size={48}
              />
              <h3 className="text-xl font-bold text-white mb-2">
                {platform.name}
              </h3>
              <p className="text-blue-200 text-sm">{platform.desc}</p>
        ...
        <GlassCard className="p-8">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
            {supportedPlatforms.slice(4).map((platform, index) => (
              <div
                key={index}
                className="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/5 transition-all"
              >
                <platform.icon
      ...
      <GlassCard className="p-8 mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h4 className="text-xl font-bold text-white mb-3">Paste URL</h4>
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl">
              3
            </div>
            ...
            <ul className="space-y-4 text-blue-200">
              ...
              <li className="flex items-start space-x-3">
                <CheckCircle
                  ...
                  size={16}
                />
                <span>Guaranteed audio quality with video+audio merging</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle
                  className="text-green-400 mt-1 flex-shrink-0"
                  size={16}
                />
                <span>Real-time progress tracking with speed and ETA</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle
                  className="text-green-400 mt-1 flex-shrink-0"
                  size={16}
                />
                <span>Multiple quality options from 360p to 4K</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle
                  className="text-green-400 mt-1 flex-shrink-0"
                  size={16}
                />
                <span>No watermarks on downloaded content</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle
                  className="text-green-400 mt-1 flex-shrink-0"
                  size={16}
                />
                <span>Works on all devices: desktop, mobile, tablet</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle
                  className="text-green-400 mt-1 flex-shrink-0"
            ...
            <ul className="space-y-4 text-blue-200">
              <li className="flex items-start space-x-3">
                <Star
                  ...
                  size={16}
                />
                <span>Built with Next.js 13+ for maximum performance</span>
              </li>
              <li className="flex items-start space-x-3">
                <Star
                  className="text-yellow-400 mt-1 flex-shrink-0"
                  size={16}
                />
                <span>Server-Side Events (SSE) for real-time progress</span>
              </li>
              <li className="flex items-start space-x-3">
                <Star
                  className="text-yellow-400 mt-1 flex-shrink-0"
              ...
              <li className="flex items-start space-x-3">
                <Star
                  ...
                  size={16}
                />
                <span>yt-dlp backend for maximum platform compatibility</span>
              </li>
              <li className="flex items-start space-x-3">
                <Star
                  className="text-yellow-400 mt-1 flex-shrink-0"
              ...
              <li className="flex items-start space-x-3">
                <Star
                  ...
                  size={16}
                />
                <span>Regular updates and new platform support</span>
              </li>
            </ul>
          </GlassCard>
        </div>
      ...
      <GlassCard className="p-8 mb-16">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-blue-200 max-w-2xl mx-auto">
            Video Grabber Pro is developed and maintained by{" "}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-4 text-blue-200">
              ...
              <p>
                Video Grabber Pro represents hundreds of hours of development,
                testing, and optimization to create the most reliable and
                feature-rich video downloader available online.
              </p>
              <p>
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">+91 9670950884</p>
                  </div>
                </div>
                <button
                  onClick={() => handleCopy("+91 9670950884", "phone")}
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200 text-sm">@mrankitpratap</p>
                    </div>
                  </div>
        ...
        <div className="space-y-6">
          <div>
            <h4 className="text-xl font-bold text-white mb-2">
              Is Video Grabber Pro completely free?
            </h4>
            <p className="text-blue-200">
              Yes! Video Grabber Pro is 100% free with no hidden costs, premium
              tiers, or subscription plans. We believe everyone should have
              access to high-quality video downloading tools.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-white mb-2">
          ...
          <div>
            <h4 className="text-xl font-bold text-white mb-2">
              Is it safe to use Video Grabber Pro?
            </h4>
            <p className="text-blue-200">
              Absolutely! We don&#39;t store your downloads, collect personal
              data, or install any software. Everything is processed securely on
              our servers with no malware, ads, or privacy concerns.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-white mb-2">
      ...
      <div className="text-center mb-16">
        <GlassCard className="p-12">
          ...
          <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
            Join thousands of users who trust Video Grabber Pro for their video
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/"
              className="inline-flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold text-lg rounded-xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              <Download size={24} />
